        ...
        <div className="flex flex-col gap-16 lg:gap-24">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    <div>
                        ...
                        <h1 className="text-4xl lg:text-6xl font-extrabold text-navy leading-tight mb-6">
                            ...
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-navy to-teal-accent">Trusted Worldwide</span>
                        </h1>
                        ...
                        <div className="flex flex-wrap gap-6">
                            <div className="text-center">
                                <p className="text-4xl font-extrabold text-navy">8+</p>
                                <p className="text-slate-500 text-sm">Years Experience</p>
                            </div>
                            <div className="text-center">
                                <p className="text-4xl font-extrabold text-navy">150+</p>
                    ...
                    <div className="relative">
                        ...
                        <div className="absolute -bottom-6 -left-6 bg-white p-6 rounded-2xl shadow-xl border border-gray-100">
                            <p className="text-navy font-bold text-lg">Site Area, Hyderabad</p>
                            <p className="text-slate-500 text-sm">Our Headquarters</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="px-5 lg:px-8 max-w-7xl mx-auto w-full">
                <div className="text-center mb-12">
                    ...
                    <h2 className="text-3xl lg:text-4xl font-extrabold text-navy mt-2">Our Core Values</h2>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {values.map((value) => (
                        <div key={value.title} className="bg-white rounded-2xl p-6 border border-gray-100 shadow-soft hover:shadow-lg transition-all hover:-translate-y-1 group">
            ...
            <section className="px-5 lg:px-8 max-w-7xl mx-auto w-full">
                <div className="text-center mb-12">
                    ...
                    <h2 className="text-3xl lg:text-4xl font-extrabold text-navy mt-2">Key Milestones</h2>
                </div>
                ...
                <div className="relative">
                    ...
                    <div className="space-y-8">
                        {milestones.map((milestone, i) => (
                            <div key={milestone.year} className={`relative flex items-center gap-8 ${i % 2 === 0 ? 'lg:flex-row' : 'lg:flex-row-reverse'}`}>
                                {/* Dot */}
                                <div className="absolute left-4 lg:left-1/2 w-4 h-4 bg-teal-accent rounded-full border-4 border-white shadow-md lg:-translate-x-1/2 z-10"></div>

                                {/* Content */}
                                <div className={`ml-12 lg:ml-0 lg:w-1/2 ${i % 2 === 0 ? 'lg:pr-16 lg:text-right' : 'lg:pl-16'}`}>
                                    <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-soft hover:shadow-lg transition-all">
                                        <span className="inline-block px-3 py-1 bg-navy text-white text-sm font-bold rounded-full mb-3">{milestone.year}</span>
            ...
            <section className="px-5 lg:px-8 max-w-7xl mx-auto w-full">
                <div className="text-center mb-12">
                    ...
                    <h2 className="text-3xl lg:text-4xl font-extrabold text-navy mt-2">Meet Our Team</h2>
                </div>
            ...
            <section className="px-5 lg:px-8 max-w-7xl mx-auto w-full">
                <div className="bg-gradient-to-br from-navy via-navy-dark to-navy rounded-3xl p-8 lg:p-12 relative overflow-hidden">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 relative z-10">
                        {TESTIMONIALS.map((t) => (
                            <div key={t.id} className="bg-white/10 backdrop-blur-sm p-6 rounded-2xl border border-white/10">
            ...
            <section className="px-5 lg:px-8 max-w-7xl mx-auto w-full pb-10">
                <div className="text-center">
                    <h2 className="text-3xl lg:text-4xl font-extrabold text-navy mb-4">Ready to Join Our Journey?</h2>
                    <p className="text-slate-500 text-lg mb-8 max-w-2xl mx-auto">Whether you're looking to build something amazing or join our team, we'd love to hear from you.</p>
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                        ...
                        <a href="mailto:careers@geezek.com" className="w-full sm:w-auto bg-white hover:bg-gray-50 text-navy px-8 py-4 rounded-xl font-bold transition-all border border-gray-200 flex items-center justify-center gap-2">
